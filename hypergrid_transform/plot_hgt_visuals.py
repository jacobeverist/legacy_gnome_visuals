...
# illustrations
from helpers.hypergrid_graphics import set_hgt_artists, build_hgt_artists, draw_bases, draw_grid, draw_gnomes, \
...
def run():
    ...
    filename_root = "visual_test_frames_1"
    ...
    xs, ys = datasets.lemiscate(n=100, alpha=0.5)
    ys = 3 * ys
    num_points = len(xs)
