...
# illustrations
from hypergrid_graphics import set_hgt_artists, build_hgt_artists, draw_bases, draw_2D_grid, draw_gnomes, \
...
def run(filename_root="visual_test_frame_1", output_dir="out"):
    ...
    colors = sns.color_palette("deep", n_colors=hgt.num_grids)
    ...
    draw_2D_grid(ax0, scaled_bases, hgt.num_bins, grid_periods=3)
    #draw_bases(ax0, hgt, colors=colors2[1:])
    draw_bases(ax0, hgt, colors=colors)
